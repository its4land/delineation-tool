...
/*****************************************************************************
        ...
        description          : this script loops over all features of given 
				shapefile and saves clipped rasters around 
				each line's pixel according to its boundary 
				label in a specific folder.
