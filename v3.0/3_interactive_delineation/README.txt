...
The two folders available here offer two appraoches for one substep (simplify segmentation), 
which can be run in QGIS or ArcGIS. 
Instructions on when and how to apply one of the approaches can be found in the wiki.
